...
def pushtoserver():#Make sure you can ssh login without a password or this will be a huge pain
	...
	bash('scp -r /home/'+username+'/pi-data/'+'/ dc@192.168.1.7:/home/dc/http/rpi1/')
	while True:
		...
		bash('scp -r /home/'+username+'/pi-data/'+year()+'/'+month()+'/'+day()+'/'+hour()+'/'+stmin()+'/ dc@192.168.1.7:/home/dc/http/rpi1/pi-data/'+year()+'/'+month()+'/'+day()+'/'+hour()+'/')
		time.sleep( 3 )
